    ...
    public class LayerAdderEditor: Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Set Default Layer Collisions"))
            {
                ...
                Physics.IgnoreLayerCollision(dic[RB_Layers.Layer_Character.ToString()], dic["Default"], false);
                Physics.IgnoreLayerCollision(dic[RB_Layers.Layer_DeadBody.ToString()], dic["Default"], false);
